...
<div id="user-update-panel" class="manage-panel">
	<h3><spring:message code="user.addTitle"/></h3>
	<form:form  modelAttribute="user" method="POST" action="/DentaSurvey/userConfigurafion/update">
	   	...
	   	<table>
		    ...
		    <tr>
		        <td colspan="2">
		            ...
		            <input id="user-update-button" class="form-button greyButton" 
